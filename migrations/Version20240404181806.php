...
final class Version20240404181806 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE IF NOT EXISTS `orders` (`order_id` INT AUTO_INCREMENT NOT NULL PRIMARY KEY, total_amount FLOAT, user_id INT, created_at DATETIME, updated_at DATETIME, FOREIGN KEY(user_id) REFERENCES user(user_id) ON UPDATE CASCADE ON DELETE CASCADE)');
